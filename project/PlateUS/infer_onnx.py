...
if __name__ == "__main__":
    ...
    parser.add_argument('--onnx_file', type=str, default='/data_249/data3/plate_rec/work/car_plate_rec/saved_model/yhl3_0.987.onnx', help='model.pt path(s)')#识别模型
    parser.add_argument('--image_path', type=str, default='/data_249/data3/plate_rec/work/car_plate_rec/train_data/yhl_test2/trans', help='source') 
